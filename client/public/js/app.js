...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    connection__WEBPACK_IMPORTED_MODULE_0__["default"].on('accusations', this.onAccusations);
  },
  methods: {
    ...
    continueToVoting: function continueToVoting() {
      connection__WEBPACK_IMPORTED_MODULE_0__["default"].emit('mayor continue to voting');
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.$emit('log', "You are a ".concat(this.data.role, "."));
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    summary: function summary() {
      if (this.chosen) return "You want to investigate ".concat(this.chosen.name, ".");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    result: function result() {
      if (this.data.friendly) return "".concat(this.data.player.name, " seems to be an ordinary villager.");
      return "Something seems off about ".concat(this.data.player.name, ".");
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    connection__WEBPACK_IMPORTED_MODULE_0__["default"].on('werewolf choices', this.onWerewolfChoices);
  },
  methods: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      mayor: false,
      phase: null,
      viewsShownForDead: ['mayor-choose-successor', 'gg-wp']
    };
  },
  mounted: function mounted() {
  ...
  watch: {
    players: function players() {
      this.alivePlayers = this.players.filter(function (player) {
        return !player.dead;
      });
    }
  }
...
var render = function() {
  ...
  return _c("div", { staticClass: "gg-wp" }, [
    ...
    _c(
      ...
      _vm._l(this.data.winners, function(player, index) {
    ...
    _c(
      ...
      _vm._l(this.data.losers, function(player, index) {
        return _c("gg-wp-player", { key: index, attrs: { player: player } })
      }),
      1
    ),
      ...
      ? _c(
          ...
          [
            _c("p", [
              ...
              _c("strong", [_vm._v(_vm._s(_vm.data.werewolfVictim.name))]),
              _vm._v(" tonight.\n\t\t")
            ]),
            _vm._v(" "),
            _vm.data.canHeal
              ? [
                  _c("input", {
                    ...
                    attrs: { type: "checkbox", id: "heal-werewolf-victim" },
                    domProps: {
                    ...
                    on: {
                      change: function($event) {
                        ...
                        if (Array.isArray($$a)) {
                          ...
                          if ($$el.checked) {
                            $$i < 0 &&
                              (_vm.healWerewolfVictim = $$a.concat([$$v]))
                          } else {
                            $$i > -1 &&
                  ...
                  _vm._v(" "),
                  _c("label", { attrs: { for: "heal-werewolf-victim" } }, [
                    _vm._v(
                      "\n\t\t\t\theal " +
          ...
          return _c("div", { class: ["player", { "--dead": player.dead }] }, [
            ...
            _c("div", { staticClass: "additional" }, [
              ...
              player.mayor
                ? _c(
                    "span",
                    { staticClass: "mayor", attrs: { title: "Mayor" } },
                    [_vm._v("m")]
                  )
                : _vm._e(),
              _vm._v(" "),
      ...
      _c(
        ...
        [
          _vm.phase
            ...
            : _vm._e(),
          _vm._v(" "),
          !_vm.dead || _vm.viewsShownForDead.includes(_vm.view)
            ? _c("pg-" + _vm.view, {
                tag: "component",
                attrs: {
                  data: _vm.actionData,
...
var render = function() {
  ...
  return _c("div", { staticClass: "lobby" }, [
    ...
    _c(
      ...
      [
        _c("h2", [_vm._v("Players in Your Lobby")]),
        _vm._v(" "),
        _vm._l(_vm.players, function(player) {
          return _c(
            "div",
